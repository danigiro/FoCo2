...
This function applies a sequential method that first reconciles the base
forecasts from each expert to satisfy the linear constraints, and then
combines the reconciled forecasts obtained so far. cssrc may be applied
only in 'balanced' cases (e.g., \\n_j = n\\ \\\forall j\\, see
Girolimetto and Di Fonzo, 2024)
...
[`csscr()`](https://danigiro.github.io/FoCo2/reference/csscr.md)
