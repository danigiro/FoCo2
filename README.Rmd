...
`r sprintf("[![devel version](https://img.shields.io/badge/devel version-%s-blue.svg)](https://github.com/danigiro/FoCo2)", gsub("Version: (.*)","\\1",  (desc <- readLines("DESCRIPTION"))[grepl("Version", desc, fixed = TRUE)]))` 
...
You can install the **stable** version on [R CRAN](https://CRAN.R-project.org/package=FoCo2)
